...
import 'package:supercab_admin/DataSource/preBookingInvoice.dart';


class PreBookingItemDetails extends StatefulWidget {

  String bookingType;
  String bookingId;
  String userId;

  PreBookingItemDetails({@required this.bookingType,@required this.bookingId,@required this.userId});

  @override
  _PreBookingItemDetailsState createState() => _PreBookingItemDetailsState();
}

class _PreBookingItemDetailsState extends State<PreBookingItemDetails> {
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      [
                                        ...
                                        SizedBox(height: 10,),
                                        Text('Booking Status : $bookingStatus', style: TextStyle(fontSize: 17, color: Colors.white),),
                                  ...
                                  isInvoiceRequired
                                    ...
                                    child: RaisedButton(
                                        ...
                                        onPressed: ()
                                        {
                                          ...
                                          Navigator.of(context).push(MaterialPageRoute(builder: (_)=>InvoiceScreenPrebookingTransfer(
                                            passengerName: name,
  ...
  callOnFcmApiSendPushNotifications(driverName,contact,arrivalTime,vehicleNumber,comment,status,message,token) async {
