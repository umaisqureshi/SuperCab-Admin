...
class HourlyTransferDetails extends StatefulWidget {

  String bookingType;
  String bookingId;
  String userId;

  HourlyTransferDetails({@required this.bookingType,@required this.bookingId,@required this.userId});

  @override
  _HourlyTransferDetailsState createState() => _HourlyTransferDetailsState();
}

class _HourlyTransferDetailsState extends State<HourlyTransferDetails> {
                                                            ...
                                                            if(validateForm())
                                                              {
                                                                ...
                                                                FirebaseFirestore.instance.collection('token').doc(widget.userId).get().then((value) {
                                                                  callOnFcmApiSendPushNotifications(driverName,driverContact,drivervehicleNumber,arrivalTime,comment,status,message,value.data()['token']);
                                                                }).then((value)
                                                                {
