...
import '../DataSource/invoice.dart';
...
class LocalDetails extends StatefulWidget {
  ...
  LocalDetails({@required this.bookingType,@required this.bookingId,@required this.userId});
                                  ...
                                  isInvoiceRequired
                                      ? Center(
                                        ...
                                        onPressed: ()
                                        {
                                          ...
                                          Navigator.of(context).push(MaterialPageRoute(builder: (_)=>InvoiceScreenLocalTransfer(
                                            passengerName: name,
