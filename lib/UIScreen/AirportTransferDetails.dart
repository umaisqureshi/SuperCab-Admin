...
class AirportTransferDetails extends StatefulWidget {

  String bookingType;
  String bookingId;
  String userId;

  AirportTransferDetails({@required this.bookingType,@required this.bookingId,@required this.userId});

  @override
  _AirportTransferDetailsState createState() => _AirportTransferDetailsState();
}

class _AirportTransferDetailsState extends State<AirportTransferDetails> {
                    ...
                    Row(
                      ...
                      [
                        ...
                        RaisedButton(
                            ...
                            onPressed: ()
                            {
                              String message = 'Your Booking Canceled!';
                              String status = 'Declined';

                              FirebaseFirestore.instance.collection('airPortBooking').doc(widget.bookingId).update({'bookingStatus' : status});
