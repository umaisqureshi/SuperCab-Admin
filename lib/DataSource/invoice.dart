...
class InvoiceScreenLocalTransfer extends StatefulWidget {
  ...
  @override
  _InvoiceScreenLocalTransferState createState() =>
      _InvoiceScreenLocalTransferState();
}

class _InvoiceScreenLocalTransferState
    extends State<InvoiceScreenLocalTransfer> {
  ...
  takeScreenShot() {
    ...
    screenshotController.capture().then((Uint8List image) async {
      ...
      final result = await ImageGallerySaver.saveImage(image).then((value) {
        ...
        File file =
            File(value['filePath'].toString().replaceAll("file://", ""));
    ...
    try {
      await FlutterEmailSender.send(email).then((value) {
        ...
        FirebaseFirestore.instance
            ...
            .update({'invoiceStatus': status}).then((value) {
          Navigator.of(context).pop();
          Navigator.of(context).pop();
        });
      });
