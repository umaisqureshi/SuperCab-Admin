...
class InvoiceScreenPrebookingTransfer extends StatefulWidget {
  ...
  InvoiceScreenPrebookingTransfer({
  ...
  @override
  _InvoiceScreenPrebookingTransferState createState() => _InvoiceScreenPrebookingTransferState();
}

class _InvoiceScreenPrebookingTransferState extends State<InvoiceScreenPrebookingTransfer> {
  ...
  sendEmail(path) async
  {
    try
    {
      ...
      final message = mailer.Message()
        ...
        ..recipients.add(widget.passengerEmail) // ahsanrazapk92@gmail.com ... m.nadeem.szd@gmail.com
  ...
  Future<void> send(path) async {
    ...
    try {
      await FlutterEmailSender.send(email).then((value)
      {
        ...
        FirebaseFirestore.instance.collection('prebooking').doc(widget.bookingId).update({'invoiceStatus' : status}).then((value)
        {
          Navigator.of(context).pop();
          Navigator.of(context).pop();
        });
